...
docker-compose -f docker-compose.yml up -d orderer.example.com ca1 ca2 ca3 couchdb1 couchdb2 couchdb3 peer0.org1.example.com peer0.org2.example.com peer0.org3.example.com cli
docker ps -a
